...
tasks {
    register<app.petermiklanek.currency.Clean>("clean")
    register<app.petermiklanek.currency.LintCheck>("lintCheck")
    register<app.petermiklanek.currency.DependencyUpdates>("dependencyUpdates")
}
